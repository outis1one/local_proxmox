...
- [Phase 7 — Convert 3.5" Drives to Non-RAID Mode](#phase-7--convert-35-drives-to-non-raid-mode)
- [Phase 8 — Map Physical Bays to Drives](#phase-8--map-physical-bays-to-drives)
- [Phase 9 — GPU Passthrough Setup](#phase-9--gpu-passthrough-setup)
- [Phase 10 — Fan Control + Staggered Spin-Up](#phase-10--fan-control--staggered-spin-up)
...
## Phase 10 — Fan Control + Staggered Spin-Up
